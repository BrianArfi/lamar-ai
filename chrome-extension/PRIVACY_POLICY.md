# Privacy Policy for Career-Ops AI Job Matchmaker & Scraper

**Last Updated: May 31, 2026**

This Privacy Policy describes how the Career-Ops AI Job Matchmaker & Scraper Chrome Extension ("the Extension") collects, uses, and protects your data.
...
- **Profile Synchronization**: Prefilled query parameters are sent securely as URL parameters directly to your local sandbox dashboard (`http://localhost:3001` or your configured SaaS host) when you explicitly click "Open in SaaS Dashboard" or "Analyze Match".
...
- `host_permissions`: Narrowly scoped to supported job platform domains (LinkedIn, Glints, Indeed, Kalibrr, JobStreet, Greenhouse, and Lever) to safely inject the content parser.
